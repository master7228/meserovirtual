                    ...
                    <div class="col-lg-12">    
                            <div class="col-md-12 ">
                                <div class="col-md-4 form-group" style="display:none">
                                    ...
                                    <input type="int" class="form-control" id="ideps" name="ideps" value="<?php echo $data[0];  ?>" required>
                                </div>
                                <div class="col-md-4 form-group ">
                                    <label for="validationCustom01" class="form-label">Nombre</label>
                                    <input type="text" class="form-control" id="eps" name="eps" value="<?php echo utf8_encode($data[1]);  ?>" required>
                            ...
                            <div class="col-md-12 ">
                                <div class="col-md-4 form-group">
                                    ...
                                    <textarea class="form-control" id="desceps" name="desceps"><?php echo utf8_encode($data[2]);  ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    event.preventDefault();
                    form.classList.add('was-validated');
                    var ideps = $.trim($("#ideps").val());
                    var eps = $.trim($("#eps").val());
                    var desceps = $.trim($("#desceps").val());

                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>EPS/edit",
                        data: {ideps:ideps, eps:eps, desceps:desceps},
                        success: function(response){
                            ...
                            if(response != 0){
                                ...
                                jQuery('#btnAceptarModal').bind( "click", function() {
                                    window.location.href = "<?php echo URL; ?>EPS/list"; 
                                });
                            }else{
                                jQuery("#modalMessage").text('Este tipo de EPS ya existe con este nombre, valida por favor!');
            ...
            $("#btnNew").click(function() {
                event.preventDefault();
                window.location.href = "<?php echo URL; ?>EPS/create"; 
            });
})()
