            ...
            <?php }else{ ?>
                <form id="frmtiponovedad" class="needs-validation" novalidate>
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col-lg-8"><h1 class="h3 mb-0 text-gray-800">Crear tipo de Nomina</h1></div>
                        ...
                        <div class="col-lg-12">   
                                ...
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <textarea class="form-control" id="descnomina" name="descnomina"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>Nomina/create",
                        data: {nomina:nomina, descnomina:descnomina},
