                        ...
                        <div class="col-lg-12">   
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="tiponovedad" name="tiponovedad" required>
                                ...
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <textarea class="form-control" id="descnovedad" name="descnovedad"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>TipoNovedad/create",
                        data: {tiponovedad:tiponovedad, descnovedad:descnovedad},
