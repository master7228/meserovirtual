<div id="content-wrapper" class="d-flex flex-column">
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <?php }else{ ?>
                <form id="frmtiponovedad" class="needs-validation" novalidate>
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col-lg-8"><h1 class="h3 mb-0 text-gray-800">Tipo de Novedades</h1></div>
                        ...
                        <div class="col-lg-12">    
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="novid" name="novid" value="<?php echo $data[0];  ?>" style="display:none" required>
                                    </div>
                                    <div class="col-md-4 form-group ">
                                        <label for="validationCustom01" class="form-label">Nombre</label>
                                        <input type="text" class="form-control" id="tiponovedad" name="tiponovedad" value="<?php echo utf8_encode($data[1]);  ?>" required>
                                        <div class="invalid-feedback">
                                            Por favor, ingresa el nombre de la novedad.
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <textarea class="form-control" id="descnovedad" name="descnovedad"><?php echo utf8_encode($data[2]);  ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    event.preventDefault();
                    form.classList.add('was-validated');
                    var novid = $.trim($("#novid").val());
                    var tiponovedad = $.trim($("#tiponovedad").val());
                    var descnovedad = $.trim($("#descnovedad").val());

                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>TipoNovedad/edit",
                        data: {novid:novid, tiponovedad:tiponovedad, descnovedad:descnovedad},
                        success: function(response){
                            if(response != 0){
                                ...
                                jQuery('#btnAceptarModal').bind( "click", function() {
                                    window.location.href = "<?php echo URL; ?>TipoNovedad/list"; 
                                });
                            }else{
                                jQuery("#modalMessage").text('Esta novedad ya existe con este nombre, valida por favor!');
            ...
            $("#btnNew").click(function() {
                event.preventDefault();
                window.location.href = "<?php echo URL; ?>TipoNovedad/create"; 
            });
})()
