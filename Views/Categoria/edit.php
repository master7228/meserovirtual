            ...
            <?php }else{ ?>
                ...
                <form id="frmzona" class="needs-validation" novalidate>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col-lg-8"><h1 class="h3 mb-0 text-gray-800">Categorias</h1></div>
                            ...
                            <?php $data = $array[0]; ?>
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="catid" name="catid" value="<?php echo $data[0] ?>" style="display:none">
                                        <input type="text" class="form-control" id="categoria" name="categoria" required value="<?php echo $data[1] ?>">
                                ...
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <textarea class="form-control" id="catdescripcion" name="catdescripcion"><?php echo $data[2] ?></textarea>
                                        <div class="invalid-feedback">
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                ...
                if (!form.checkValidity()) {
                    ...
                    var catdescripcion = $.trim($("#catdescripcion").val());
                    var catid = $.trim($("#catid").val());

                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>Categoria/edit",
                        data: {catid:catid, categoria: categoria, catdescripcion:catdescripcion},
                        success: function(response){
                            if(response != 0){
                                ...
                                jQuery('#btnAceptarModal').bind( "click", function() {
                                    window.location.href = "<?php echo URL; ?>Categoria/list"; 
                                });
                            }else{
                                jQuery("#modalMessage").text('Esta categoria ya existe, valida por favor!');
            ...
            $("#btnNew").click(function() {
                console.log('aqui');
                event.preventDefault()
                window.location.href = "<?php echo URL; ?>Categoria/create"; 
            });
})()
