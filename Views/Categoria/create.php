                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <textarea class="form-control" id="catdescripcion" name="catdescripcion"></textarea>
                                    </div>
                                </div>
                         </div>
                    </div>      
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>Categoria/create",
                        data: {categoria: categoria, catdescripcion:catdescripcion},
