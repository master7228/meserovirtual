            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        <a class="dropdown-item" id="showGeneralModal" href="#" data-toggle="modal" data-target="#generalModal"></a>
                    </div>
                </li>
            </ul>
        </nav>
            ...
            <?php }else{ ?>
                ...
                <form id="frmzona" class="needs-validation" novalidate>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col-lg-8"><h1 class="h3 mb-0 text-gray-800">Bodegas</h1></div>
                            ...
                            <?php $data = $array[0]; ?>
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="bodid" name="bodid" value="<?php echo $data[0] ?>" style="display:none">
                                        <input type="text" class="form-control" id="bodega" name="bodega" required value="<?php echo $data[1] ?>">
                                        <div class="invalid-feedback">
                                            Por favor, ingresa la bodega.
                                        </div>
                                    </div>
                                    <div class="col-md-4 form-group ">
                                        <label for="validationCustom01" class="form-label">Nombre</label>
                                        <input type="text" class="form-control" id="bodnombre" name="bodnombre" required value="<?php echo $data[2] ?>">
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <textarea class="form-control" id="boddescripcion" name="boddescripcion"><?php echo $data[3]; ?></textarea>
                                        <div class="invalid-feedback">
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                ...
                if (!form.checkValidity()) {
                    ...
                    var bodnombre = $.trim($("#bodnombre").val());
                    var boddescripcion = $.trim($("#boddescripcion").val());
                    var bodid = $.trim($("#bodid").val());

                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>Bodega/edit",
                        data: {bodid:bodid, bodega: bodega, bodnombre:bodnombre, boddescripcion:boddescripcion},
                        success: function(response){
                            ...
                            if(response != 0){
                                ...
                                jQuery('#btnAceptarModal').bind( "click", function() {
                                    window.location.href = "<?php echo URL; ?>Bodega/list"; 
                                });
                            }else{
                                jQuery("#modalMessage").text('Esta bodega ya existe con este nombre, valida por favor!');
            ...
            $("#btnNew").click(function() {
                event.preventDefault()
                window.location.href = "<?php echo URL; ?>Bodega/create"; 
            });
})()
