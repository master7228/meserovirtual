    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <?php }else{ ?>
                ...
                <form id="frmbodega" class="needs-validation" novalidate>
                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="bodnombre" name="bodnombre" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <textarea class="form-control" id="boddescripcion" name="boddescripcion"></textarea>
                                    </div>
                                </div>
                        </div>
                    </div>
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>Bodega/create",
                        data: {bodega: bodega, bodnombre:bodnombre, boddescripcion:boddescripcion},
                        success: function(response){
                            ...
                            if(response != 0){
                                ...
                                jQuery("#modalMessage").text('Este nombre ya existe con esta bodega, valida por favor!');
