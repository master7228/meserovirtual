                ...
                <div class="col-lg-12">  
                        <div class="col-md-12 ">
                            <div class="col-md-4 form-group ">
                                ...
                                <input type="text" class="form-control" id="zoncodigo" name="zoncodigo" required>
                            ...
                            <div class="col-md-4 form-group ">
                                ...
                                <input type="text" class="form-control" id="zonnombre" name="zonnombre" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-12 ">
                            <div class="col-md-4 form-group">
                                ...
                                <textarea class="form-control" id="zondescripcion" name="zondescripcion"></textarea>
                                <div class="invalid-feedback">
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                ...
                if (!form.checkValidity()) {
                    ...
                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>Zona/create",
                        data: {zoncodigo: zoncodigo, zonnombre:zonnombre, zondescripcion:zondescripcion},
                        success: function(response){
                            ...
                            //document.location = "<?php //echo URL; ?>Customer/create";
                                ...
                                jQuery("#modalMessage").text('Este zona ya existe, valida por favor!')
                                jQuery("#showGeneralModal")[0].click();
                            }
                        }
                    });
