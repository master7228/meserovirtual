                        ...
                        <div class="col-lg-12">    
                                <div class="col-md-12 ">
                                    ...
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="carid" name="carid" value="<?php echo $data[0][0];  ?>" style="display:none" required>
                                        <input type="text" class="form-control" id="carcargo" name="carcargo" value="<?php echo $data[0][2];  ?>" required>
                                        <div class="invalid-feedback">
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>Cargo/edit",
                        data: {carid:carid, caridpro:caridpro, carcargo: carcargo},
                        success: function(response){
                            ...
                            if(response != 0){
                                ...
                                jQuery("#modalMessage").text('Esta cargo ya existe con este proceso, valida por favor!');
