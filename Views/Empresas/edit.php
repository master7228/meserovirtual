<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div class="container-fluid">
        ...
        <?php }else{ ?>
            <form id="frmempresas" class="needs-validation" novalidate>
                
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <div class="col-lg-8"><h1 class="h3 mb-0 text-gray-800">Empresas y Proveedores</h1></div>
                    ...
                    <div class="col-lg-12">    
                            <div class="col-md-12 ">
                                <div class="col-md-4 form-group" style="display:none">
                                    ...
                                    <input type="text" class="form-control" id="idemp" name="idemp" value="<?php echo $data[0];  ?>" required>
                                </div>
                                <div class="col-md-4 form-group ">
                                    <label for="validationCustom01" class="form-label">Nombre</label>
                                    <input type="text" class="form-control" id="nombreempresa" name="nombreempresa" value="<?php echo utf8_encode($data[1]);  ?>" required>
                            ...
                            <div class="col-md-12 ">
                                <div class="col-md-4 form-group">
                                    ...
                                    <input class="form-control" id="nitempresa" name="nitempresa" value="<?php echo utf8_encode($data[2]);  ?>">
                                </div>
                            </div>
                            <div class="col-md-12 ">
                                <div class="col-md-4 form-group">
                                    <label for="validationCustom02" class="form-label">Descripción</label>
                                    <textarea class="form-control" id="descempresa" name="descempresa"><?php echo utf8_encode($data[3]);  ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    event.preventDefault();
                    form.classList.add('was-validated');
                    var idemp = $.trim($("#idemp").val());
                    var nombreempresa = $.trim($("#nombreempresa").val());
                    var nitempresa = $.trim($("#nitempresa").val());
                    var descempresa = $.trim($("#descempresa").val());

                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>Empresas/edit",
                        data: {idemp:idemp, nombreempresa:nombreempresa, nitempresa:nitempresa, descempresa:descempresa},
                        success: function(response){
                            ...
                            if(response != 0){
                                ...
                                jQuery('#btnAceptarModal').bind( "click", function() {
                                    window.location.href = "<?php echo URL; ?>Empresas/list"; 
                                });
                            }else{
            ...
            $("#btnNew").click(function() {
                event.preventDefault();
                window.location.href = "<?php echo URL; ?>Empresas/create"; 
            });
})()
