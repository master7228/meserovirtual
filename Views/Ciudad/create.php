                        ...
                        <div class="col-lg-12">    
                                <div class="col-md-12 ">
                                    ...
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="ciucodigo" name="ciucodigo" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="ciunombre" name="ciunombre" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <textarea class="form-control" id="ciudescripcion" name="ciudescripcion"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div> 
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>Ciudad/create",
                        data: {ciuiddep:ciuiddep, ciucodigo: ciucodigo, ciunombre:ciunombre, ciudescripcion:ciudescripcion},
