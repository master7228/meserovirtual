        ...
        <?php }else{ ?>
            <form id="frmnomina" class="needs-validation" novalidate>
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <div class="col-lg-8"><h1 class="h3 mb-0 text-gray-800">Editar tipo de Contrato</h1></div>
                    ...
                    <div class="col-lg-12">    
                            <div class="col-md-12 ">
                                <div class="col-md-4 form-group" style="display:none">
                                    ...
                                    <input type="int" class="form-control" id="idcontrato" name="idcontrato" value="<?php echo $data[0];  ?>" required>
                                </div>
                                <div class="col-md-4 form-group ">
                                    <label for="validationCustom01" class="form-label">Nombre</label>
                                    <input type="text" class="form-control" id="contrato" name="contrato" value="<?php echo utf8_encode($data[1]);  ?>" required>
                                    <div class="invalid-feedback">
                                        Por favor, ingresa el nombre del tipo de Contrato.
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 ">
                                <div class="col-md-4 form-group">
                                    ...
                                    <textarea class="form-control" id="desccontrato" name="desccontrato"><?php echo utf8_encode($data[2]);  ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    event.preventDefault();
                    form.classList.add('was-validated');
                    var idcontrato = $.trim($("#idcontrato").val());
                    var contrato = $.trim($("#contrato").val());
                    var desccontrato = $.trim($("#desccontrato").val());

                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>Contratos/edit",
                        data: {idcontrato:idcontrato, contrato:contrato, desccontrato:desccontrato},
                        success: function(response){
                            ...
                            if(response != 0){
                                ...
                                jQuery('#btnAceptarModal').bind( "click", function() {
                                    window.location.href = "<?php echo URL; ?>Contratos/list"; 
                                });
                            }else{
                                jQuery("#modalMessage").text('Este tipo de Contrato ya existe con este nombre, valida por favor!');
            ...
            $("#btnNew").click(function() {
                event.preventDefault();
                window.location.href = "<?php echo URL; ?>Contratos/create"; 
            });
})()
