            ...
            <?php }else{ ?>
                <form id="frmdepartamento" class="needs-validation" novalidate>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col-lg-8"><h1 class="h3 mb-0 text-gray-800">Departamentos</h1></div>
                            ...
                            <?php $data = $array[0]; ?>
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="depid" name="depid" value="<?php echo $data[0] ?>" style="display:none">
                                        <input type="text" class="form-control" id="depcodigo" name="depcodigo" required value="<?php echo $data[1] ?>">
                                    ...
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="depnombre" name="depnombre" required value="<?php echo $data[2] ?>">
                                        <!--<div class="valid-feedback">
                                        ¡Se ve bien!
                                        </div>-->
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <textarea class="form-control" id="depdescripcion" name="depdescripcion"><?php echo $data[3] ?></textarea>
                                        <!--<div class="valid-feedback">
                                        ¡Se ve bien!
                                        </div>-->
                                        <div class="invalid-feedback">
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                ...
                if (!form.checkValidity()) {
                    ...
                    form.classList.add('was-validated')
                    var depcodigo = $.trim($("#depcodigo").val());
                    var depnombre = $.trim($("#depnombre").val());
                    var depdescripcion = $.trim($("#depdescripcion").val());
                    var depid = $.trim($("#depid").val());

                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>Departamento/edit",
                        data: {depid:depid, depcodigo: depcodigo, depnombre:depnombre, depdescripcion:depdescripcion},
                        success: function(response){
                            ...
                            if(response != 0){
                                ...
                                jQuery('#btnAceptarModal').bind( "click", function() {
                                    window.location.href = "<?php echo URL; ?>Departamento/list"; 
                                });
                            }else{
            ...
            $("#btnNew").click(function() {
                event.preventDefault()
                window.location.href = "<?php echo URL; ?>Departamento/create"; 
            });
})()
