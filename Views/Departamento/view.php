                ...
                <div class="col-lg-12">
                        ...
                        <div class="col-md-12 ">
                            <div class="col-md-4 form-group ">
                                ...
                                <input type="text" class="form-control" id="depcodigo" name="depcodigo" required>
                            ...
                            <div class="col-md-4 form-group ">
                                ...
                                <input type="text" class="form-control" id="depnombre" name="depnombre" required>
                                <!--<div class="valid-feedback">
                                ¡Se ve bien!
                                </div>-->
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-12 ">
                            <div class="col-md-4 form-group">
                                ...
                                <textarea class="form-control" id="depdescripcion" name="depdescripcion"></textarea>
                                <!--<div class="valid-feedback">
                                ¡Se ve bien!
                                </div>-->
                                <div class="invalid-feedback">
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                ...
                if (!form.checkValidity()) {
                    ...
                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>Departamento/create",
                        data: {depcodigo: depcodigo, depnombre:depnombre, depdescripcion:depdescripcion},
                        success: function(response){
                            ...
                            //document.location = "<?php //echo URL; ?>Customer/create";
                                ...
                                jQuery("#modalMessage").text('Este departamento ya existe, valida por favor!')
                                jQuery("#showGeneralModal")[0].click();
                            }
                        }
                    });
