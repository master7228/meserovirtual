                            ...
                            <?php $data = $array[0]; ?>
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="sanid" name="sanid" value="<?php echo $data[0] ?>" style="display:none">
                                        <input type="text" class="form-control" id="santipo" name="santipo" required value="<?php echo $data[1] ?>">
                                ...
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <textarea class="form-control" id="sandescripcion" name="sandescripcion"><?php echo $data[2] ?></textarea>
                                        <div class="invalid-feedback">
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                ...
                if (!form.checkValidity()) {
                    ...
                    var sanid = $.trim($("#sanid").val());

                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>TipoSangre/edit",
                        data: {sanid:sanid, santipo: santipo, sandescripcion:sandescripcion},
