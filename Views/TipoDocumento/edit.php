            ...
            <?php }else{ ?>
                <form id="frmzona" class="needs-validation" novalidate>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col-lg-8"><h1 class="h3 mb-0 text-gray-800">Tipo Documentos</h1></div>
                            ...
                            <?php $data = $array[0]; ?>
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="docid" name="docid" value="<?php echo $data[0] ?>" style="display:none">
                                        <input type="text" class="form-control" id="doctipo" name="doctipo" required value="<?php echo $data[1] ?>">
                                    ...
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="docnombre" name="docnombre" required value="<?php echo $data[2] ?>">
                                        <div class="invalid-feedback">
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                ...
                if (!form.checkValidity()) {
                    ...
                    form.classList.add('was-validated')
                    var doctipo = $.trim($("#doctipo").val());
                    var docnombre = $.trim($("#docnombre").val());
                    var docid = $.trim($("#docid").val());

                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>TipoDocumento/edit",
                        data: {docid:docid, doctipo: doctipo, docnombre:docnombre},
                        success: function(response){
                            ...
                            if(response != 0){
                                ...
                                jQuery('#btnAceptarModal').bind( "click", function() {
                                    window.location.href = "<?php echo URL; ?>TipoDocumento/list"; 
                                });
                            }else{
                                jQuery("#modalMessage").text('Este tipo de documento ya existe, valida por favor!');
            ...
            $("#btnNew").click(function() {
                event.preventDefault()
                window.location.href = "<?php echo URL; ?>TipoDocumento/create"; 
            });
})()
