                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="doctipo" name="doctipo" required>
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>TipoDocumento/create",
                        data: {doctipo: doctipo, docnombre:docnombre},
                        success: function(response){
                            ...
                            if(response != 0){
                                ...
                                jQuery("#modalMessage").text('Esta tipo de documento ya existe, valida por favor!');
