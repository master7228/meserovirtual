    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <?php }else{ ?>
                ...
                <form id="frmtiposede" class="needs-validation" novalidate>
                    <!-- Page Heading -->
                        ...
                        <div class="col-lg-12">          
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="tiposedenombre" name="tiposedenombre" required>
                                ...
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <textarea class="form-control" id="tiposededescripcion" name="tiposededescripcion"></textarea>
                                        <div class="invalid-feedback">
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                ...
                if (!form.checkValidity()) {
                    ...
                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>TipoSede/create",
                        data: {tiposedenombre: tiposedenombre, tiposededescripcion:tiposededescripcion},
                        success: function(response){
                            ...
                            if(response != 0){
                                ...
                                jQuery("#modalMessage").text('Este tipo de sede ya existe con este nombre, valida por favor!');
