            ...
            <?php }else{ ?>
                <form id="frmtiponovedad" class="needs-validation" novalidate>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col-lg-8"><h1 class="h3 mb-0 text-gray-800">Crear tipo de Cesantias</h1></div>
                        ...
                        <div class="col-lg-12">   
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="cesantia" name="cesantia" required>
                                ...
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <textarea class="form-control" id="desccesantia" name="desccesantia"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>Cesantias/create",
                        data: {cesantia:cesantia, desccesantia:desccesantia},
                        success: function(response){
                            ...
                            if(response != 0){
                                ...
                                jQuery("#modalMessage").text('Este tipo de Cesantia ya existe con este nombre, valida por favor!');
