            ...
            <?php }else{ ?>
                ...
                <form id="frmtiponovedad" class="needs-validation" novalidate>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col-lg-8"><h1 class="h3 mb-0 text-gray-800">Crear Caja de Compensacion</h1></div>
                                ...
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <div class="invalid-feedback">
                                            Por favor, ingresa el nombre de la Caja de Compensacion.
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <textarea class="form-control" id="desccaja" name="desccaja"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>CajasCompensacion/create",
                        data: {caja:caja, desccaja:desccaja},
                        success: function(response){
                            ...
                            if(response != 0){
                                ...
                                jQuery("#modalMessage").text('Este una Caja de Compensacion ya existe con este nombre, valida por favor!');
