            ...
            <?php }else{ ?>
                ...
                <form id="frmnomina" class="needs-validation" novalidate>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col-lg-8"><h1 class="h3 mb-0 text-gray-800">Editar tipo de EPS</h1></div>
                        ...
                        <div class="col-lg-12">    
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group" style="display:none">
                                        ...
                                        <input type="int" class="form-control" id="idcaja" name="idcaja" value="<?php echo $data[0];  ?>" required>
                                    </div>
                                    <div class="col-md-4 form-group ">
                                        <label for="validationCustom01" class="form-label">Nombre</label>
                                        <input type="text" class="form-control" id="caja" name="caja" value="<?php echo utf8_encode($data[1]);  ?>" required>
                                ...
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <textarea class="form-control" id="desccaja" name="desccaja"><?php echo utf8_encode($data[2]);  ?></textarea>
                                    </div>
                                </div>
                            </div>
                    </div>
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    event.preventDefault();
                    form.classList.add('was-validated');
                    var idcaja = $.trim($("#idcaja").val());
                    var caja = $.trim($("#caja").val());
                    var desccaja = $.trim($("#desccaja").val());

                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>CajasCompensacion/edit",
                        data: {idcaja:idcaja, caja:caja, desccaja:desccaja},
                        success: function(response){
                            ...
                            if(response != 0){
                                ...
                                jQuery('#btnAceptarModal').bind( "click", function() {
                                    window.location.href = "<?php echo URL; ?>CajasCompensacion/list"; 
                                });
                            }else{
                                jQuery("#modalMessage").text('Esta Caja de Compensacion ya existe con este nombre, valida por favor!');
