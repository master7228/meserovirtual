            ...
            <?php }else{ ?>
                <form id="frmzona" class="needs-validation" novalidate>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col-lg-8"><h1 class="h3 mb-0 text-gray-800">Procesos</h1></div>
                            ...
                            <?php $data = $array[0]; ?>
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="procid" name="procid" value="<?php echo $data[0] ?>" style="display:none">
                                        <input type="text" class="form-control" id="proccodigo" name="proccodigo" required value="<?php echo $data[1] ?>">
                                    ...
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="procnombre" name="procnombre" required value="<?php echo $data[2] ?>">
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <textarea class="form-control" id="procdescripcion" name="procdescripcion"><?php echo $data[3] ?></textarea>
                                        <div class="invalid-feedback">
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                ...
                if (!form.checkValidity()) {
                    ...
                    form.classList.add('was-validated')
                    var proccodigo = $.trim($("#proccodigo").val());
                    var procnombre = $.trim($("#procnombre").val());
                    var procdescripcion = $.trim($("#procdescripcion").val());
                    var procid = $.trim($("#procid").val());

                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>Proceso/edit",
                        data: {procid:procid, proccodigo: proccodigo, procnombre:procnombre, procdescripcion:procdescripcion},
                        success: function(response){
                            ...
                            if(response != 0){
                                ...
                                jQuery('#btnAceptarModal').bind( "click", function() {
                                    window.location.href = "<?php echo URL; ?>Proceso/list"; 
                                });
                            }else{
                                jQuery("#modalMessage").text('Este proceso ya existe con este código, valida por favor!');
            ...
            $("#btnNew").click(function() {
                event.preventDefault()
                window.location.href = "<?php echo URL; ?>Proceso/create"; 
            });
})()
