                        ...
                        <div class="col-lg-12">
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="proccodigo" name="proccodigo" required>
                                    ...
                                    <div class="col-md-4 form-group ">
                                        ...
                                        <input type="text" class="form-control" id="procnombre" name="procnombre" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-12 ">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <textarea class="form-control" id="procdescripcion" name="procdescripcion"></textarea>
                                    </div>
                                </div>
                        </div>
                    </div>     
  ...
  Array.prototype.slice.call(forms)
            ...
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>Proceso/create",
                        data: {proccodigo: proccodigo, procnombre:procnombre, procdescripcion:procdescripcion},
                        success: function(response){
                            ...
                            if(response != 0){
                                ...
                                jQuery("#modalMessage").text('Esta proceso ya existe con este código, valida por favor!');
